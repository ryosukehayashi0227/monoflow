...
const Common = {
    I18N: {
        ja: {
            ...
            help_nf_blocker_d: '「これが終わらないと着手できない」タスクを設定できます。カード上のリンクアイコンにマウスを乗せると、依存関係が線で可視化されます。',
        ...
        en: {
            ...
            help_nf_blocker_d: 'Set tasks that must be finished first. Hover over the link icon on a card to visualize connections with a dynamic line.',
