...
const Common = {
    ...
    I18N: {
        ja: {
            ...
            help_m5_t: '5. データ管理とカスタマイズ',
            help_m5_h1: 'エクスポート（バックアップ）',
            help_m5_l1: 'JSON形式で全データをダウンロード保存します。ラベル設定などもすべて含まれます。',
            help_m5_h2: 'インポート（復元）',
            help_m5_l2: 'バックアップからデータを復元します。確認ダイアログが表示されるので安心です。',
            help_m5_h3: 'ダークモード',
            help_m5_l4: '月アイコンをクリックしてテーマ切り替え。目の疲れを軽減します。',
        ...
        en: {
            ...
            help_m4_l3: 'The storage shelf concept.',
            help_m4_privacy_t: 'Data Privacy',
            help_m4_privacy_d: 'Your data is 100% private. It lives exclusively in your browser\'s local storage and never touches a server.',
            help_m5_t: '5. Data & Customization',
            help_m5_h1: 'Export (Backup)',
            help_m5_l1: 'Download full data as JSON. Includes all settings and labels.',
            help_m5_h2: 'Import (Restore)',
            help_m5_l2: 'Restore data from backup. Includes safety confirmation dialog.',
            help_m5_h3: 'Dark Mode',
            help_m5_l4: 'Toggle theme via the moon icon to reduce eye strain.',
            help_step_1: 'VISUALS',
            help_step_2: 'HIERARCHY',
            help_step_3: 'SEARCH',
            help_step_4: 'ANALYTICS',
